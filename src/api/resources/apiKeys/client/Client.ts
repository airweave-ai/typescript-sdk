...
export class ApiKeys {
    ...
    public async readApiKeys(
        ...
        const _response = await core.fetcher({
            url: urlJoin(await core.Supplier.get(this._options.environment), "api_keys/"),
            method: "GET",
            headers: {
                "x-api-key":
    ...
    public async readApiKey(id: string, requestOptions?: ApiKeys.RequestOptions): Promise<AirweaveSDK.ApiKey> {
        const _response = await core.fetcher({
            url: urlJoin(await core.Supplier.get(this._options.environment), `api_keys/${encodeURIComponent(id)}`),
            method: "GET",
            headers: {
                "x-api-key":
                    (await core.Supplier.get(this._options.apiKey)) != null

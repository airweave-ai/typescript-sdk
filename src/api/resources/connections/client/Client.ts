...
export class Connections {
    ...
    public async listAllConnectedIntegrations(
        ...
        const _response = await core.fetcher({
            url: urlJoin(await core.Supplier.get(this._options.environment), "connections/list"),
            method: "GET",
            headers: {
                "x-api-key":
                    (await core.Supplier.get(this._options.apiKey)) != null
    ...
    public async getOauth2AuthUrl(
        ...
        const _response = await core.fetcher({
            url: urlJoin(await core.Supplier.get(this._options.environment), "connections/oauth2/source/auth_url"),
            method: "GET",
            headers: {
                "x-api-key":
                    (await core.Supplier.get(this._options.apiKey)) != null
    ...
    public async sendOauth2Code(
        ...
        const _response = await core.fetcher({
            url: urlJoin(await core.Supplier.get(this._options.environment), "connections/oauth2/source/code"),
            method: "POST",
            headers: {
                "x-api-key":
                    (await core.Supplier.get(this._options.apiKey)) != null

...
export const SourceWithAuthenticationFields: core.serialization.ObjectSchema<
    serializers.SourceWithAuthenticationFields.Raw,
    AirweaveSDK.SourceWithAuthenticationFields

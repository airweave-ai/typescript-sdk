...
export const EmbeddingModelWithAuthenticationFields: core.serialization.ObjectSchema<
    serializers.EmbeddingModelWithAuthenticationFields.Raw,
    AirweaveSDK.EmbeddingModelWithAuthenticationFields

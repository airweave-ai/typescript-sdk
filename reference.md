...
<details><summary><code>client.users.<a href="/src/api/resources/users/client/Client.ts">readUser</a>({ ...params }) -> AirweaveSDK.User</code></summary>
<dl>
<dd>
...
<details><summary><code>client.users.<a href="/src/api/resources/users/client/Client.ts">createOrUpdateUser</a>({ ...params }) -> AirweaveSDK.User</code></summary>
<dl>
<dd>
...
<details><summary><code>client.destinations.<a href="/src/api/resources/destinations/client/Client.ts">listDestinations</a>({ ...params }) -> AirweaveSDK.Destination[]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.destinations.<a href="/src/api/resources/destinations/client/Client.ts">readDestination</a>(shortName, { ...params }) -> AirweaveSDK.DestinationWithConfigFields</code></summary>
<dl>
<dd>
...
<details><summary><code>client.entities.<a href="/src/api/resources/entities/client/Client.ts">listEntityDefinitions</a>({ ...params }) -> AirweaveSDK.EntityDefinition[]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.entities.<a href="/src/api/resources/entities/client/Client.ts">listEntityRelations</a>({ ...params }) -> AirweaveSDK.EntityRelation[]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.transformers.<a href="/src/api/resources/transformers/client/Client.ts">listTransformers</a>({ ...params }) -> AirweaveSDK.Transformer[]</code></summary>
<dl>
<dd>
